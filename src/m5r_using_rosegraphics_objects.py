...
#            window = rg.RoseWindow(width(init 400),hight(init 300),
# name appears
#  on the top)
#
...
#           window = rg.RosedWindow(400,100,hello)
#
...
#                .centerpoint  radious outline_color thickness
#
#     f. What does a RoseWindow RENDER method do?
#            draw all the thing on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It close the window when mouse click, it appears at the end of
# each drawing
#
